...
echo.
echo Now creating UPnP component directory...
md "%girder%\luascript\components\UPnP (xPL)"

echo.
echo Now copying documentation...
xcopy /S/E docs\*.* "%girder%\%girderdoc%\xPL"
echo.
echo Now copying xPL component, UPnP component and support files...
xcopy /S/E/Y luascript\*.* "%girder%\luascript\"
echo.
echo Now copying xPL userinterface and action files...
